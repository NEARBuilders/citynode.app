...
export const testContract = oc.router({
  ...
  getById: oc
    .route({
      ...
      description:
        "Fetches a single test item by its unique identifier. This is the primary method for retrieving individual items.",
      tags: ["Items"],
    })
    .input(
      z.object({
  ...
  simpleStream: oc
    .route({
      ...
      description:
        "Returns a fixed number of test items as a server-side event stream. Useful for testing streaming functionality.",
      tags: ["Streaming"],
    })
    .input(
      z.object({
  ...
  emptyStream: oc
    .route({
      ...
      description:
        "Returns an empty stream for testing edge cases. Useful for testing how clients handle empty iterators.",
      tags: ["Streaming"],
    })
    .input(
      z.object({
  ...
  throwError: oc
    .route({
      ...
      description:
        "Deliberately throws different types of errors for testing error handling. Useful for validating client error handling.",
      tags: ["Testing"],
    })
    .input(
      z.object({
        errorType: z
          .enum(["UNAUTHORIZED", "FORBIDDEN", "RATE_LIMITED", "SERVICE_UNAVAILABLE"])
  ...
  requiresSpecialConfig: oc
    .route({
      ...
      description:
        "Validates that the plugin configuration is working correctly. Returns configuration values for verification.",
      tags: ["Testing"],
    })
    .input(
      z.object({
  ...
  useClient: oc
    .route({
      ...
      description:
        "Tests that client objects with methods are preserved through Module Federation.",
      tags: ["Testing"],
    })
    .input(
      z.object({
