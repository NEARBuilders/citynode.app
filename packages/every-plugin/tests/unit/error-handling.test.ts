...
describe("Error Handling Utilities", () => {
  ...
  describe("isRetryableError", () => {
    ...
    it("should respect defaultRetryable parameter when no pattern matches", () => {
      ...
      const retryableResult = toPluginRuntimeError(
        error,
        "test-plugin",
        undefined,
        undefined,
      ...
      const nonRetryableResult = toPluginRuntimeError(
        error,
        "test-plugin",
        undefined,
        undefined,
  ...
  describe("toPluginRuntimeError", () => {
    it("should wrap ORPCError with correct properties", () => {
      ...
      const result = toPluginRuntimeError(
        orpcError,
        "test-plugin",
        "testProcedure",
        "test-operation",
  ...
  describe("Error categorization", () => {
    it("should categorize connection errors", () => {
      const connectionErrors = ["ECONNREFUSED", "ENOTFOUND", "EHOSTUNREACH"];
    ...
    it("should categorize authentication errors", () => {
      const authErrors = ["401 Unauthorized", "Authentication failed", "Invalid credentials"];
    ...
    it("should categorize permission errors", () => {
      const permissionErrors = ["EACCES", "Permission denied", "Access forbidden"];
