...
import type { AuthOrganizationContext, AuthOrganizationSummary, AuthPluginContext } from "./auth-types.gen";
...
type OrgMetaType<TSchema extends z.ZodType | undefined> =
  TSchema extends z.ZodType ? z.infer<TSchema> : Record<string, unknown>;

export type OrgAuthenticatedContext<TMeta extends Record<string, unknown> = Record<string, unknown>> = AuthenticatedContext & {
...
export type OrgMemberAuthenticatedContext<TMeta extends Record<string, unknown> = Record<string, unknown>> = AuthenticatedContext & {
  organization: NonNullable<AuthOrganizationContext> & {
    activeOrganizationId: string;
...
>(
  ...
  type UserMiddleware = DecoratedMiddleware<AuthContext, { userId: string; user: RequestAuthUser }, any, any, any, any>;
  ...
  type MemberMiddleware = DecoratedMiddleware<
    ...
    any
  >;
  type ApiKeyMiddleware = DecoratedMiddleware<AuthContext, { apiKey: ApiKeyContext }, any, any, any, any>;
  ...
  ) as DecoratedMiddleware<AuthContext, {}, any, any, any, any>;
        ...
        context: {
          ...
          organization: {
            ...
            organization: org.organization
              ? { ...org.organization, metadata: parseOrgMetadata(org.organization.metadata, options?.orgMetaSchema) }
              : null,
          },
        },
      });
