...
export function AuthShell({ session, runtimeConfig, isAdmin = false }: AuthShellProps) {
  ...
  const visibleItems = filterSidebarByRole(sidebarItems, getUserRole(!!session?.user, isAdmin));
